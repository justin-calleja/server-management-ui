  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <g id="Group">
            {Server.app1RunCircle(app1.appState)}
            {Server.app1InitCircle(app1.appState)}
            {Server.app1OffCircle(app1.appState)}
            {Server.app2RunCircle(app2.appState)}
            {Server.app2InitCircle(app2.appState)}
            {Server.app2OffCircle(app2.appState)}
            <path
...
// This lets the Typescript compiler know that the values of the Server.appStateNames object are of type import("../..").AppState
// otherwise, if you go to assign one of these values where an AppState is required, you'll get:
// Type 'string' is not assignable to type 'AppState'.
/** @type {{[s: string]: import("../..").AppState}} */
...
const appPropType = PropTypes.shape({
  ...
  appState: PropTypes.oneOf(Object.values(Server.appStateNames))
});
